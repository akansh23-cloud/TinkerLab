...
class MaterialIdentityV13(Base):
    ...
    material_id: Mapped[str] = mapped_column(ForeignKey("materials.id", ondelete="CASCADE"), nullable=False, unique=True, index=True)
    ...
    __table_args__ = (Index("ix_material_identity_v13_composition_material", "composition_fingerprint", "material_id"),)
