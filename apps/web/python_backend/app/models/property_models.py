...
class PropertyModelV13(Base):
    """Versioned provenance-bound property model; valid only inside its declared envelope."""
    ...
    property_definition_id: Mapped[str] = mapped_column(ForeignKey("material_property_definitions.id", ondelete="CASCADE"), nullable=False, index=True)
