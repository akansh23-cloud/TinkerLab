...
def classify_legacy_evidence_tier(*, evidence_type: str | None, source_quality: str | None, evidence_metadata: dict[str, Any] | None = None, material_source_type: str | None = None) -> tuple[EvidenceTier | None, EvidenceTierStatus, str]:
