...
def engineering_identity_fingerprint(*, composition: dict[str, float], phase_polytype: dict[str, Any], microstructure: dict[str, Any], processing_route: dict[str, Any], form_factor: dict[str, Any], crystallographic_orientation: dict[str, Any], defect_state: dict[str, Any]) -> str:
    payload = {
...
def differing_identity_dimensions(left: Any, right: Any) -> tuple[str, ...]:
    dimensions = ("phase_polytype", "microstructure", "processing_route", "form_factor", "crystallographic_orientation", "defect_state")
