...
export default function MaterialsExplorer(){
  ...
  return <>
    <div className="topline"><div><div className="eyebrow">Knowledge graph</div><h1>Materials explorer</h1><div className="muted">Search normalized material identities and inspect evidence coverage without collapsing conflicting observations.</div></div><Link className="btn btn-secondary" href="/imports">Import data</Link></div>
    ...
    <div className="card"><div className="table-wrap"><table><thead><tr><th>Material</th><th>Identifiers</th><th>Family</th><th>Evidence coverage</th><th>Conflicts</th><th>Source</th></tr></thead><tbody>
      ...
      {!result.isLoading&&result.data?.length===0&&<tr><td colSpan={6}><div className="empty">No visible materials match the current filters.</div></td></tr>}
